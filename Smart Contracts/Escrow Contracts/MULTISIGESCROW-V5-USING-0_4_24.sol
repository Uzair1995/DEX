...
contract MultiSigWallet {
    ...
    uint public buyerDisputeCode;
    uint public sellerDisputeCode;
    ...
    modifier sellerDisputeRaiseCheck() {
        if(!sellerDisputeRaise)
            revert();
        _;    
    }
    modifier buyerDisputeRaiseCheck() {
        if(!buyerDisputeRaise)
            revert();
        _;    
    }
    ...
    function raiseDisputeForSeller(uint _sellerDisputeCode) external onlySellerAllowed nonzeroBuyerAmountCheck nonzeroSellerAmountCheck {
        sellerDisputeRaise = true;
        sellerDisputeCode = _sellerDisputeCode;
    }
    function raiseDisputeForBuyer(uint _buyerDisputeCode) external onlyBuyerAllowed nonzeroBuyerAmountCheck nonzeroSellerAmountCheck {
        buyerDisputeRaise = true;
        buyerDisputeCode = _buyerDisputeCode;
    }
}