...
contract DEX_MainContract {
    ...
    function getSellOfferFromTradeHash(bytes32 _tradeHash) view public returns(string, uint, uint, address, address, address) {
        return (
    ...
    function getSellOfferDetailsFromTradeHash(bytes32 _tradeHash) view public returns(uint, string, string) {
        return (
    ...
    function getBuyOfferFromTradeHash(bytes32 _tradeHash) view public returns(string, uint, uint, address, address, address) {
        return (
    ...
    function getBuyOfferDetailsFromTradeHash(bytes32 _tradeHash) view public returns(uint, string, string) {
        return (
