...
contract EscrowContract {
    ...
    constructor (bytes32 _tradeHash, address _sellerAddress, address _buyerAddress, address _arbitratorAddress, uint _arbitratorFees, uint _offeredAmount) public {
        owner = msg.sender;
    ...
    //private functions
    function clearDataInContract() private {
        IDEX_MainContract mainContractInterface = IDEX_MainContract(owner);
        mainContractInterface.completeOffer(tradeHash);
        offeredAmount = 0;
