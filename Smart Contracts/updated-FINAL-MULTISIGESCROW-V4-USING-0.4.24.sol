...
contract MultiSigWallet {
    ...
    function raiseDisputeForSeller() external onlySellerAllowed nonzeroBuyerAmountCheck nonzeroSellerAmountCheck {
        sellerDisputeRaise = true;
    }
    
    function raiseDisputeForBuyer() external onlyBuyerAllowed nonzeroBuyerAmountCheck nonzeroSellerAmountCheck {
